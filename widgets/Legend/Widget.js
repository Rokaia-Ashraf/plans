  ...
  var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    _createLegendForOperationalLayers: function () {
      ...
      this.legend = new Legend(
        legendParams,
        html.create("div", {}, this.operationalLayersPart)
      );
      this.legend.startup();
    },
    ...
    _createLegendForBasemaplLayers: function () {
      ...
      this.legendForBasemap = new Legend(
        legendParams,
        html.create("div", {}, this.basemapLayersDiv)
      );
    ...
    _getBasemapLayerInfosParam: function () {
      var layerInfosParam = [];
      array.forEach(
        this._jimuLayerInfos.getBasemapLayers(),
        function (basemapLayerObject) {
    ...
    _getLayerInfosParam: function () {
      ...
      */
      ...
      layerInfosParam = basemapLayerInfosParam.concat(
        legendUtils.getLayerInfosParam(this.config)
      );
